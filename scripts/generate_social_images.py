...
from analytics_priority_enhancements import apply_analytics_priority_enhancements
...
def main() -> None:
    ...
    milestone_results = add_milestone_timelines(public_dir, (1995, 1996, 1997, 1998, 1999, 2000, 2001))
